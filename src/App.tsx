...
import CalculatePrice from "./pages/procurement/CalculatePrice";
import Quotation from "./pages/procurement/Quotation";
import QuotationHistory from "./pages/procurement/QuotationHistory";
import ApprovalPrice from "./pages/procurement/ApprovalPrice";
import JobTracking from "./pages/procurement/JobTracking";
import DeliveredJobs from "./pages/procurement/DeliveredJobs";
import PurchaseRequisition from "./pages/procurement/PurchaseRequisition";
import ProcurementInventoryStock from "./pages/procurement/InventoryStock";
...
import ProductInventory from "./pages/accounting/ProductInventory";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/procurement/estimation/calculate" element={
            <DashboardLayout>
              <CalculatePrice />
            </DashboardLayout>
          } />
          ...
          <Route path="/procurement/estimation/approval" element={
            <DashboardLayout>
              <ApprovalPrice />
            </DashboardLayout>
          } />
          ...
          <Route path="/procurement/job-tracking" element={
            <DashboardLayout>
              <JobTracking />
            </DashboardLayout>
          } />
          <Route path="/procurement/delivered-jobs" element={
            <DashboardLayout>
              <DeliveredJobs />
            </DashboardLayout>
          } />
