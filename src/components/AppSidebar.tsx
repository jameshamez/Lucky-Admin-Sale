...
const salesItems = [
  ...
  { title: "ติดตามออเดอร์", url: "/sales/track-orders", icon: Eye },
  { title: "สต็อกสินค้า", url: "/sales/inventory", icon: Boxes },
...
const procurementItems = [
  ...
  { 
    ...
    icon: DollarSign,
    children: [
      { title: "รายการขอราคา", url: "/procurement/estimation/calculate", icon: Calculator },
      { title: "อนุมัติราคา", url: "/procurement/estimation/approval", icon: Clipboard },
      { title: "เสนอราคา", url: "/procurement/estimation/quotation", icon: FileText },
      { title: "ประวัติการขอราคา", url: "/procurement/estimation/history", icon: History }
    ]
  },
  { title: "สั่งซื้อวัสดุอุปกรณ์", url: "/procurement/purchase-requisition", icon: ShoppingCart },
  { title: "อัปเดตงาน / ตรวจสอบสถานะ", url: "/procurement/job-tracking", icon: Eye },
  { title: "งานที่จัดส่งแล้ว", url: "/procurement/delivered-jobs", icon: Truck },
...
const productionItems = [
  ...
  { title: "การผลิตและติดตามสถานะงาน", url: "/production/orders", icon: Eye },
  { 
    title: "คลังสินค้า", 
    url: "/production/inventory", 
    icon: Package, 
    children: [
      { title: "ภาพรวมสต็อก", url: "/production/inventory-dashboard", icon: BarChart3 },
      { title: "รายการสต็อกทั้งหมด", url: "/production/inventory-all", icon: Boxes },
      { title: "รับเข้าสินค้า", url: "/production/inventory-receive", icon: PackagePlus },
      { title: "สินค้ามีตำหนิ", url: "/production/inventory-defective", icon: AlertTriangle },
      { title: "สินค้าชำรุด", url: "/production/inventory-damaged", icon: XCircle },
      { title: "โอนย้ายคลัง", url: "/production/inventory-transfer", icon: ArrowRightLeft },
      { title: "ปรับยอด/นับสต็อก", url: "/production/inventory-adjust", icon: FileEdit },
      { title: "ประวัติการเคลื่อนไหว", url: "/production/inventory-history", icon: History },
      { title: "ตั้งค่า", url: "/production/inventory-settings", icon: Settings }
    ]
  },
  { title: "รายละเอียดงานของพนักงาน", url: "/production/employee-tasks", icon: ClipboardList },
  { title: "การจัดการขอใช้รถ", url: "/production/vehicle-management", icon: Car },
  { title: "คู่มือการทำงาน", url: "/production/user-manual", icon: BookOpen },
  { title: "รายงานผล", url: "/production/reports", icon: FileBarChart }
];
...
const accountingItems = [
  ...
  { title: "สต๊อกวัสดุสำนักงาน", url: "/accounting/office-inventory", icon: Package },
